...
app.config['MYSQL_DATABASE_USER'] = 'aredotech'
app.config['MYSQL_DATABASE_PASSWORD'] = 'Aredotech_1'
...
# Write a function named `home` which returns 'Welcome to the Aredo Bookstore API Service',
# and assign to the static route of ('/')
@app.route('/')
def home():
    return "Welcome to Aredo's Bookstore API Service"
